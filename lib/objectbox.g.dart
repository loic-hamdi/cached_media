...
import 'entity_cached_media_info.dart';
...
ModelDefinition getObjectBoxModel() {
  ...
  final bindings = <Type, EntityDefinition>{
    CachedMediaInfo: EntityDefinition<CachedMediaInfo>(
        model: _entities[0],
        toOneRelations: (CachedMediaInfo object) => [],
        toManyRelations: (CachedMediaInfo object) => {},
        getId: (CachedMediaInfo object) => object.id,
        setId: (CachedMediaInfo object, int id) {
          object.id = id;
        },
